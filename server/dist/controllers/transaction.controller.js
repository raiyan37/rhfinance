 ...
 */
export const getTransaction = catchErrors(async (req, res) => {
    const userId = req.userId;
    const { id } = req.params;
 ...
 */
export const updateTransaction = catchErrors(async (req, res) => {
    const userId = req.userId;
    const { id } = req.params;
    ...
    // Find and update
    const transaction = await Transaction.findOneAndUpdate({ _id: id, userId }, {
        ...(name && { name }),
 ...
 */
export const deleteTransaction = catchErrors(async (req, res) => {
    const userId = req.userId;
    const { id } = req.params;
