...
import { validateBody, validateParams, createBudgetSchema, updateBudgetSchema, idParamSchema, } from '../middleware/validation.js';
const router = Router();
 ...
 */
router.get('/:id', validateParams(idParamSchema), budgetController.getBudget);
/**
 * POST /api/budgets
 * Create budget
 *
 ...
 */
router.post('/', writeLimiter, validateBody(createBudgetSchema), budgetController.createBudget);
/**
 * PUT /api/budgets/:id
 * Update budget
 *
 ...
 */
router.put('/:id', writeLimiter, validateParams(idParamSchema), validateBody(updateBudgetSchema), budgetController.updateBudget);
/**
 ...
 * - ID validation
 */
router.delete('/:id', writeLimiter, validateParams(idParamSchema), budgetController.deleteBudget);
