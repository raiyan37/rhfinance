...
import { validateBody, validateQuery, validateParams, createTransactionSchema, updateTransactionSchema, transactionQuerySchema, idParamSchema, } from '../middleware/validation.js';
const router = Router();
 ...
 */
router.get('/:id', validateParams(idParamSchema), transactionController.getTransaction);
/**
 ...
 */
router.post('/', writeLimiter, validateBody(createTransactionSchema), transactionController.createTransaction);
/**
 ...
 */
router.put('/:id', writeLimiter, validateParams(idParamSchema), validateBody(updateTransactionSchema), transactionController.updateTransaction);
/**
 ...
 * - ID validation
 */
router.delete('/:id', writeLimiter, validateParams(idParamSchema), transactionController.deleteTransaction);
