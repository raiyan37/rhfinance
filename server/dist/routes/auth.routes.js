...
import { register, login, googleAuth, getMe, logout, refreshToken, } from '../controllers/auth.controller.js';
import { authenticate } from '../middleware/auth.middleware.js';
import { authLimiter } from '../middleware/rateLimiter.js';
import { validateBody, registerSchema, loginSchema, googleAuthSchema, } from '../middleware/validation.js';
const router = Router();
// =============================================================================
 ...
 */
router.post('/register', authLimiter, // SECURITY: Prevent brute force
 ...
 * - Input validation
 */
router.post('/login', authLimiter, // SECURITY: Prevent credential stuffing
